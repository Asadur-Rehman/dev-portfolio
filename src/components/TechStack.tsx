...
export function TechStack() {
  ...
  return (
    <>
      <SectionDivider />
      <section id="tech" ref={ref} className="relative py-24 sm:py-36 px-5 sm:px-10 lg:px-20 border-y border-border/60 bg-background-2/40" aria-labelledby="tech-heading">
        {/* Orbit ring */}
